...
// 1. The useData() hook gives us access to page data, including current language.
const { lang } = useData()

// 2. We create a "dictionary" with all translations.
const translations = {
  pt: {
    headline: 'API Documentation Starter',
    ...
    secondaryButtonLink: 'https://github.com/rafactx/api-docs-starter',
    imageAltText: 'Preview da documentação API Documentation Starter'
  },
  en: {
    headline: 'API Documentation Starter',
    ...
    secondaryButtonText: 'GitHub',
    secondaryButtonLink: 'https://github.com/rafactx/api-docs-starter',
    imageAltText: 'Preview of the API Documentation Starter'
  },
  es: {
    headline: 'API Documentation Starter',
    ...
    secondaryButtonText: 'GitHub',
    secondaryButtonLink: 'https://github.com/rafactx/api-docs-starter',
    imageAltText: 'Vista previa de la documentación API Documentation Starter'
  },
  fr: {
    headline: 'API Documentation Starter',
    ...
    secondaryButtonText: "GitHub",
    secondaryButtonLink: 'https://github.com/rafactx/api-docs-starter',
    imageAltText: "Aperçu de la documentation API Documentation Starter"
  }
}

// 3. Create a computed property that selects the correct text set based on language.
// If language is not found, it uses 'pt' as default.
const t = computed(() => translations[lang.value] || translations.pt)

// 4. Props that don't change with language can remain.
...
// The headline now comes from our translation object 't'.
